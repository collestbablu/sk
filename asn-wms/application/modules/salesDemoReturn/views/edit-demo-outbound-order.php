...
<?php if($_GET['id']!=''){ ?>
		<h4 class="panel-title">Update Demo Return</h4>
		<?php }elseif($_GET['view']!=''){ ?>
		<h4 class="panel-title">View Demo Return</h4>
		<?php }else{ ?> 
		<h4 class="panel-title"><strong>Add Demo Return</strong></h4>
		<?php } ?>
...
<div class="col-sm-4">
 <input type="text" name="rgp_gatepass_no" value="<?php echo $branchFetch->rgp_gatepass_no; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
  </div> 
</div>
<div class="field">
...
<div class="col-sm-4" id="regid"> 
<input type="date" name="manual_gp_date"  value="<?php echo $branchFetch->manual_gp_date; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div>  
...
<div class="col-sm-4" id="regid"> 
 <select name="stock_position" id="contact_id"  onChange="getOrg(this.value);"  class="form-control ui fluid search dropdown email"  <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?> >
	...
	?>
   <option value="<?=$getBooking->code;?>" <?php if($getBooking->code==$branchFetch->stock_position){?> selected <?php }?>><?=$getBooking->first_name;?></option>
   <?php }?>
  </select>
...
<th><input type="text"   style="width:70px;" id="qn" class="form-control"> </th>
<th><input type="text"  id="qty_stock" style="width:70px;" class="form-control"> </th>
...
<input type="hidden" name="main_loc[]" id="main_loc<?php echo $z;?>" value="<?php echo $invoiceFetch->main_loc;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">


<input type="text" name="main_lochhh[]" id="main_locjj<?php echo $z;?>" value="<?php echo $getLoc->location_name;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">
...
<input type="text" name="locsdff[]" id="locdfsd<?php echo $z;?>" value="<?php echo $getMLoc->keyvalue;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">
