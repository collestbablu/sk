...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<li><a class="btn btn-success btn-sm" href="<?=base_url();?><?=base_url();?>salesDemoReturn/manageDemoOutbound">Manage Demo Outbound</a></li> 
...
$cr=date('Y');
$fyr="{$cr}-04";
$checkDataQuery=$this->db->query("select * from tbl_return_hdr ");
...
<th>&nbsp;</th>
<th><input class="btn btn-primary btn-sm" type="button" value="SAVE"   id="sv1" onClick="fsv(this)" >&nbsp;<a href="<?=base_url();?>salesDemoReturn/manageDemoOutbound" class="btn btn-blue btn-sm">Cancel</a></th></th>
</tr>
</tbody>
</table>
</div>
