...
Please find below RGP Demo Materials issue and overdue items pending to return to warehouse:</p></td>
</tr>
...
$id=implode(",",$resultstr);


$inviceQ=$this->db->query("select * from tbl_return_dtl where returnhdr in ($id)");
...
<td class="td-rl"><?=$hdrFetch->stock_pos;?></td>
</tr>
<?php $n++; }?>
