...
$fetchrecord=$this->db->query("select * from tbl_contact_m where code='".$inviceres->stock_position."'");
...
<td colspan="4"><strong><?=$inviceres->manual_gate_pass_no;?></strong></td>
</tr>

<tr>
<td colspan="5" class="td-r"><strong>C/O Geodis Overseas Private Limited</strong></td>
<td colspan="4"><strong>RGP OUT NO.</strong></td>
<td colspan="4"><strong>: <?=$inviceres->rgp_gatepass_no;?></strong></td>
</tr>

<tr>
<td colspan="5" class="td-r"><strong>Khasra No 36/1, VPO Bamnoli , Near Pole No 646</strong></td>
<td colspan="4"><strong>Date</strong></td>
<td colspan="4"><strong>: <?=$inviceres->manual_gp_date;?></strong></td>
</tr>
...
<td colspan="8"><strong>Sennheiser Electronics India Pvt. Ltd.</strong></td>
</tr>
...
<tr>
<td colspan="13" class="tr-t tr-b">For the purpose of - Demo</td>
</tr>
...
extract($_POST);
$n=1;
$inviceQ=$this->db->query("select * from tbl_return_dtl where returnhdr='".$_GET['id']."'");
...
<td colspan="2" class="td-rl"><?=$pfetch->gst;
$gstChop=chop($pfetch->gst,"%");
?></td>
<td class="td-rl"><?=$taxTot=$cal*$gstChop/100;?></td>
