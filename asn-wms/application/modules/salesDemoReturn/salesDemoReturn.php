...
public function send_remainder_mail_third_party()
{
	@extract($_POST);
...
//	$resultstr[]=$getResult->contact_id;
			...
			//$email_id=$getResult->email_id;
		$this->email->from('collestbablu@gmail.com','sk');
		//$this->email->to('prahladhsingh.in@gmail.com');
		//$this->email->to('prahalad.singh.ext@geodis.com');
...
{
/*
$email = 'collestbablu@gmail.com';
$list_id = '31792a56ff';
$api_key = '74e64c10078b204e1da027b1e2ae35cd-us20';
...
$result = $this->mailchimp->post("lists/$list_id/members", [
                'email_address' => 'bablukkhan@gmail.com',
                'merge_fields' => ['FNAME'=>'bablu', 'LNAME'=>'khan'],
                'status'        => 'subscribed',
            ]);
...
//		foreach($remQuery->result() as $getResult){
$this->email->from('collestbablu@gmail.com', 'Sk');
$this->email->to('safi.khan@berylsystems.com');
...
$to = 'collestbablu@gmail.com';
$to1 = 'collestbablu@gmail.com';
$content = '<p>this is the emails html <a href="www.google.co.uk">content</a></p>';
$subject = 'this is the subject';
$from = 'collestbablu@gmail.com';
$from1 = 'sk';

$uri = 'https://mandrillapp.com/api/1.0/messages/send.json';
$api_key = 'e6IBGXL_NJnI68VxPXuWGA';
...
if( $mandrill_ready ) {
	...
	$email = array(
		...
		'from_email' => 'collestbablu@gmail.com',
		'from_name' => 'Me-Oh-My',
		'to' => array(array('email' => 'collestbablu@gmail.com' )) //Check documentation for more details on this one
