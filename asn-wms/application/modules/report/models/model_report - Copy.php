...
function getDelhiStock($last,$strat)
{
	 if($this->session->userdata('user_id')=='1')
	 {
	 	$query=$this->db->query("Select * from tbl_product_serial_log where type != 'Stock In'  limit $strat,$last ");
	 }
	 else
	 {
	 	$query=$this->db->query("Select * from tbl_product_serial_log where type != 'Stock In' AND comp_id='".$this->session->userdata('comp_id')."' limit $strat,$last ");
	 }
	 return $result=$query->result();  
}
...
function filterDelhiStockList($perpage,$pages,$get)
{
		...
		if($this->session->userdata('user_id')=='1')
		{
			$qry = "Select * from tbl_product_serial_log  where type != 'Stock In' ";
		}
		else
		{
			$qry = "Select * from tbl_product_serial_log  where type != 'Stock In' AND comp_id='".$this->session->userdata('comp_id')."' ";
		}
...
function getLocationFresh($last,$strat)
{
	if($this->session->userdata('user_id')=='1') 	
	{
		$query=$this->db->query("Select * from tbl_product_serial where location_id='54' limit $strat,$last ");
	}
	else
	{
...
function getLocationDellPallet($last,$strat)
{
	...
	if($this->session->userdata('user_id')=='1') 	
	{ 
		$query=$this->db->query("Select * from tbl_product_serial where location_id='55' limit $strat,$last ");
	}
	else
	{
...
function filterLocationDellPalletList($perpage,$pages,$get)
{
		...
		if($this->session->userdata('user_id')=='1') 	
		{ 
			$qry = "Select * from tbl_product_serial where location_id='55' ";
		}
		else
		{
...
function getLocationDemo($last,$strat)
{
	if($this->session->userdata('user_id')=='1') 	
	{ 
		$query=$this->db->query("Select * from tbl_product_serial where location_id='56' limit $strat,$last ");
	}
	else
	{
...
function filterLocationDemoList($perpage,$pages,$get)
{
		...
		if($this->session->userdata('user_id')=='1') 	
		{ 	
			$qry = "Select * from tbl_product_serial where location_id='56' ";
		}
		else
		{
...
function getLocationBlock($last,$strat)
{
	if($this->session->userdata('user_id')=='1') 	
	{
		$query=$this->db->query("Select * from tbl_product_serial where location_id='76' limit $strat,$last ");
	}
	else
	{
...
function filterLocationBlockList($perpage,$pages,$get)
{
	if($this->session->userdata('user_id')=='1') 	
	{
		$qry = "Select * from tbl_product_serial where location_id='76' ";
	}
	else
	{
...
function getLocationSRN($last,$strat)
{
	if($this->session->userdata('user_id')=='1') 	
	{ 	
		$query=$this->db->query("Select * from tbl_product_serial where location_id='57' limit $strat,$last ");
	}
	else
	{
...
function filterLocationSrnList($perpage,$pages,$get)
{
	...
	if($this->session->userdata('user_id')=='1') 	
	{
		$qry = "Select * from tbl_product_serial where location_id='57' ";
	}
	else
	{
...
function getLocationService($last,$strat)
{
	if($this->session->userdata('user_id')=='1') 	
	{ 
		$query=$this->db->query("Select * from tbl_product_serial where location_id='58' limit $strat,$last ");
	}
	else
	{
...
function filterLocationServiceList($perpage,$pages,$get)
{
		...
		if($this->session->userdata('user_id')=='1') 	
		{ 
			$qry = "Select * from tbl_product_serial where location_id='58' ";
		}
		else
		{
...
function getLocationMktFoc($last,$strat)
{
	if($this->session->userdata('user_id')=='1') 	
	{
		$query=$this->db->query("Select * from tbl_product_serial where location_id='59' limit $strat,$last ");
	}
	else
	{
...
function filterLocationMktFocList($perpage,$pages,$get)
{
	...
	if($this->session->userdata('user_id')=='1') 	
	{
		$qry = "Select * from tbl_product_serial where location_id='59' ";
	}
	else
	{
...
function getLocationBrochure($last,$strat)
{
	if($this->session->userdata('user_id')=='1') 	
	{
		$query=$this->db->query("Select * from tbl_product_serial where location_id='60' limit $strat,$last ");
	}
	else
	{
...
function filterLocationBrochureList($perpage,$pages,$get)
{
	...
	if($this->session->userdata('user_id')=='1') 	
	{
    	$qry = "Select * from tbl_product_serial where location_id='60' ";
	}
	else
	{
