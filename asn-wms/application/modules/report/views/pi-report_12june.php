...
<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Show
<select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries"  url="<?=base_url('/report/Report/searchPI');?>" class="form-control input-sm">
...
echo $getBookingType->productname;
?>
</th>
...
if($loc!='')
{
$fetchQ21=$this->db->query("select SUM(quantity) as qtyy from tbl_product_serial where product_id='$rows->product_id' and location_id='$loc' and comp_id='".$this->session->userdata('comp_id')."'   ");
}
else
{
