...
$contents="SERIAL NO.,PG GROUP,CATEGORY,MODEL NO.,DESCRIPTION 1,DESCRIPTION 2,BLOCK,BANGALORE,TOTAL,MRP,INVENTORY TYPE Q1,REMARKS \n";	
...
$filename = "PG_Group_72_Blr"."_".@date('Y-m-d');
