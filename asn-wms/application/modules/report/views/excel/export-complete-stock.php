...
$contents="SERIAL NO.,PG GROUP,CATEGORY,MODEL NO.,DESCRIPTION 1,DESCRIPTION 2,BLOCK,DELHI,BANGALORE,DEL PALLET,SERVICE,SALES RETURN,TOTAL,MRP,INVENTORY TYPE Q1,REMARKS,RANKING \n";	
...
$filename = "CompleteStockWithBlr"."_".@date('Y-m-d');
