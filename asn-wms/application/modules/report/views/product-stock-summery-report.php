...
<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Show
<select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries"  url="<?=base_url('/report/Report/searchProductStockSummery');?>" class="form-control input-sm">
...
<th><?php 
	...
	$sql1 = $this->db->query("select * from tbl_location where id='".$rows->main_location_id."' ");
			$sql2 = $sql1->row();
...
function exportTableToExcel(tableID, filename = ''){
    ...
    // Specify file name
    filename = filename?filename+'.xls':'ProductStockSummeryReport_<?php echo date('d-m-Y');?>.xls';
