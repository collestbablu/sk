...
$getStockIn=$stockInQuery->row();
		...
		$sql1 = $this->db->query("select * from tbl_contact_m where code='$getStockIn->contact_id' ");
		$sql2 = $sql1->row();
		//echo $sql2->first_name;	
}
else
{
		$sql1 = $this->db->query("select * from tbl_contact_m where code='$getHdr->contact_id' ");
		$sql2 = $sql1->row();
		echo $sql2->first_name;	
}
		?>
