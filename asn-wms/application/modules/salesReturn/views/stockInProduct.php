...
<input type="hidden" name="type" value="<?=$getHdr->type;?>" />
<?php
...
$queryInbondQtyCnt=$this->db->query("select * from tbl_product_serial_log where product_id='$getProductName->Product_id' and inbound_id='".$_GET['id']."' and type!=''");
