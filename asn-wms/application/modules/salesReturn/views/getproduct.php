...

    {
	  ...
	  alert("Your broweser doesnot support ajax");
		...
		//document.getElementById("spid").value=tid;
		  ...
		  function abc(pt,pr,tid,q,u,quantity,pid,hsn,sku_no,des2){
...
<input type="text" id="ty<?php echo $id;?>"  class="prds" value="<?php echo $arr->productname.'' ?>" name="<?php echo $id;?>"
 onFocus="abc(this.value,'<?php echo $arr->mrp; ?>',this.id,'<?php echo $qty; ?>','<?php echo $usunit; ?>','<?php echo $arr->quantity; ?>','<?php echo $arr->Product_id; ?>','<?php echo $arr->hsn_code; ?>','<?php echo $arr->sku_no; ?>','<?php echo $arr->description2; ?>')"
 onClick="abc(this.value,'<?php echo $arr->mrp; ?>',this.id,'<?php echo $qty; ?>','<?php echo $usunit; ?>','<?php echo $arr->quantity; ?>','<?php echo $arr->Product_id; ?>','<?php echo $arr->hsn_code; ?>','<?php echo $arr->sku_no; ?>','<?php echo $arr->description2; ?>')" style="width:240px;border:1px solid;" tabindex="-1"  readonly >
