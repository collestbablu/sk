...
//===================================start 5th cell================================
	    ...
	    cell = row.insertCell(indexcell);
				...
				var hsn = document.createElement("input");
							...
							hsn.id='hsn_code'+rid;
							hsn.readOnly = true;
							hsn.style="text-align:center";
							hsn.style.width="100%";
							hsn.style.border="hidden"; 
							cell.appendChild(hsn);
		//===============================close 5th cell=================================
...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success" href="<?=base_url();?><?=base_url();?>salesReturn/manageSRN">Manage Return</a></li> 
		...
		<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong><a href="#">Add Return</a></strong></li> 
			</ol>
		<?php }?>
...
<div class="col-sm-4" id="regid"> 
<input type=time  name="original_inv_rec_time" value="<?php echo $branchFetch->original_inv_rec_time; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" required>
</div> 
</div>
...
<div class="col-sm-4">
  <select name="contact_id"  class="form-control ui fluid search dropdown email" required <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?> >
	...
	?>
   <option value="<?=$getBooking->contact_id;?>" <?php if($getBooking->contact_id==$contact_id->destination){?> selected <?php }?>><?=$getBooking->first_name;?></option>
   <?php }?>
  </select>
  </div> 
</div>
...
<th><input type="number" readonly step="any" name="saleamnt" id="disAmt" class="form-control"   style="width:70px;"/ ></th>
...
<th>&nbsp;</th>
<th><input class="btn btn-primary" type="button" value="SAVE"   id="sv1" onClick="fsv(this)" >&nbsp;<a href="<?=base_url();?>salesReturn/manageSRN" class="btn btn-blue">Cancel</a></th></th>
</tr>
</tbody>
</table>
</div>
