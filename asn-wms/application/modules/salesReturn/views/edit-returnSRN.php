...
var entr =(e.keyCode);
if(document.getElementById("hsn_code").value=="" && entr==08){
...
$location='manage_item';
		...
		$userQuery = $this -> db
           -> select('*')
		   -> where('returnid',$_GET['id'])
		   -> or_where('returnid',$_GET['view'])
           -> get('tbl_return_hdr');
...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success" href="<?=base_url();?><?=base_url();?>inbound/manageInbound">Manage Return</a></li> 
		...
		<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong><a href="#">Edit Return</a></strong></li> 
			</ol>
		<?php }?>
...
<?php if($_GET['id']!=''){ ?>
		<h4 class="panel-title">Update Return</h4>
		<?php }elseif($_GET['view']!=''){ ?>
		<h4 class="panel-title">View Return</h4>
		<?php }else{ ?> 
		<h4 class="panel-title"><strong>Add Return</strong></h4>
		<?php } ?>
...
<div class="col-sm-4" id="regid"> 
<input  type=time min=9:00 max=17:00 step=900 name="original_inv_rec_time" value="<?php echo $branchFetch->original_inv_rec_time; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" required>
</div> 
</div>
...
<div class="col-sm-4">
  <select name="contact_id"  class="form-control ui fluid search dropdown email" required <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?> >
	...
	?>
   <option value="<?=$getBooking->contact_id;?>" <?php if($getBooking->contact_id==$branchFetch->contact_id){?> selected <?php }?>><?=$getBooking->first_name;?></option>
   <?php }?>
  </select>
  </div> 
</div>
...
<select name="type"  class="form-control ui fluid search dropdown email" required <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?> >
    <option value="">----Select ----</option>
    <?php
...
<div class="col-sm-4" id="regid"> 
<input type="text" name="order_no" min="1" step="any" value="<?php echo $branchFetch->order_no; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" required>
</div>  
<label class="col-sm-2 control-label">*Invoice No.:</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" name="invoice_no" value="<?php echo $branchFetch->invoice_no; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" required>
</div> 
</div>
...
<div class="col-sm-4">
 <input type="text" class="form-control" name="remarks" value="<?=$branchFetch->remarks;?>">
  </div> 
</div>
<div class="field">
...
<td align="center" style="width: 9%;"><input type="text" name="pd[]" id="pd<?php echo $z;?>" value="<?php echo $getProductName->sku_no;?>" readonly="" style="text-align: center; width: 100%; border:hidden;">

<td align="center" style="width: 9%;"><input type="text" name="pddfg[]" id="des1<?php echo $z;?>" value="<?php echo $getProductName->productname;?>" readonly="" style="text-align: center; width: 100%; border:hidden;">

<td align="center" style="width: 9%;"><input type="text" name="pd23[]" id="des2<?php echo $z;?>" value="<?php echo $getProductName->description2;?>" readonly="" style="text-align: center; width: 100%; border:hidden;">
