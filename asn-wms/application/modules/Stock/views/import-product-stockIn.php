...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success" href="<?=base_url();?>master/Item/manage_item">Import Stock In</a></li> 
		...
		<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong><a href="#">Import Stock In</a></strong></li> 
			</ol>
		<?php }?>
...
<form action="insert_stockIn" method="post" enctype="multipart/form-data">
