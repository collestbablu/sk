...
//echo "select *from tbl_location_rack where rack_name='".$getData[2]."'";
 $unitId=$this->db->query("select *from tbl_location_rack where rack_name='".$getData[2]."'");
 $unitRow=$unitId->row();
...
if($getData[0]!='Model')
{
	...
	//echo "insert into tbl_product_serial set product_id='$proRow->Product_id',quantity='".$getData[1]."',main_location_id='1',location_id='54',rack_id='$unitRow->id',comp_id='".$this->session->userdata('comp_id')."'";
		...
		$this->db->query("insert into tbl_product_serial set product_id='$proRow->Product_id',quantity='".$getData[1]."',main_location_id='1',location_id='54',rack_id='$unitRow->id',comp_id='".$this->session->userdata('comp_id')."'");
		
		$this->db->query("insert into tbl_product_serial_log set product_id='$proRow->Product_id',quantity='".$getData[1]."',main_location_id='1',location_id='54',rack_id='$unitRow->id',comp_id='".$this->session->userdata('comp_id')."',type='Stock In'");
