...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success" href="<?=base_url();?><?=base_url();?>outbound/manageOutbound">Manage Outbound</a></li> 
...
<th>
<input type="number" min="1"    style="width:70px;" id="qn" class="form-control"> 
</th>
<th>
...
<td style="width:3%;"> <div align="center"><u>Location</u></div>
...
<th>&nbsp;</th>
<th><input class="btn btn-primary" type="button" value="SAVE"   id="sv1" onClick="fsv(this)" >&nbsp;<a href="<?=base_url();?>outbound/manageOutbound" class="btn btn-blue">Cancel</a></th></th>
</tr>
</tbody>
</table>
</div>
