...
<input type="hidden" name="type[]" value="Sales Return" />
...
$queryInbondQtyCnt=$this->db->query("select * from tbl_product_serial_log where product_id='$getProductName->Product_id' and inbound_id='".$_GET['id']."' and type='Sales Return'");

$queryInbondQty=$this->db->query("select SUM(quantity) as Qtyy from tbl_product_serial_log where product_id='$getProductName->Product_id' and inbound_id='".$_GET['id']."' and type='Sales Return' ");
