...
<td align="center" style="width: 3%;">
<input type="text" name="main_loc[]" id="main_loc<?php echo $z;?>" value="<?php echo $invoiceFetch->main_loc;?>" readonly="" style="text-align: center; width: 100%; border: hidden;"></td>


<td align="center" style="width: 3%;">
<input type="text" name="loc[]" id="loc<?php echo $z;?>" value="<?php echo $invoiceFetch->loc;?>" readonly="" style="text-align: center; width: 100%; border: hidden;"></td>

<td align="center" style="width: 3%;">
<input type="text" name="rack_id[]" id="rack_id<?php echo $z;?>" value="<?php echo $invoiceFetch->rack_id;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">
