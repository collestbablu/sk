...
<script src="https://cdn.ckeditor.com/4.7.1/standard/ckeditor.js"></script>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success btn-sm" href="<?=base_url();?>admin/masterdata/manage_master_data">Manage Master Data</a></li> 
...
<div class="col-sm-4"> 
<textarea name="description" style="width:400px;" id="termandcondition" class="form-control" type="text" <?php if($_GET['view']!='') {?> readonly="" <?php }?>><?php echo $branchFetch->description?></textarea>
</div> 
</div>
<div class="form-group">
...
<a href="" onclick="popupclose(this.value)"  title="Cancel" class="btn btn-blue btn-sm"> Cancel</a>
		...
		<input type="submit" class="btn btn-primary btn-sm" value="Save">
       <a href="<?=base_url();?>admin/masterdata/manage_master_data" class="btn btn-blue btn-sm">Cancel</a>
