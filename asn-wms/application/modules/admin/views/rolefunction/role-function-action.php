...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success btn-sm" href="<?=base_url();?>admin/rolefunction/role_function_action">Role Function Action</a></li> 
...
<h4 class="panel-title"><strong>Add Role Function Action</strong></h4>
...
<div class="panel panel-default">
<div class="panel-heading clearfix">
<h4 class="panel-title">Add Role Function Action</h4>
<ul class="panel-tool-options"> 
<li><a data-rel="reload" href="#"><i class="icon-arrows-ccw"></i></a></li>
</ul>
</div>
<div class="panel-body">
 <div class="well">
<div class="col-sm-4 contol-r">Product Name</div>
...
extract(@$_POST);
  if(@$Show!='')
  {
	...
	?>	
<div class="form-group"> 
<label class="col-sm-4 control-label"><?php echo $line->function_name ;?></label> 
<div class="col-sm-6"> 
...
<?php } } ?>
<div class="col-sm-6">
<button type="button" class="btn btn-primary btn-sm" onclick="myfunction()">Save</button>
<button type="submit" class="btn btn-blue btn-sm">Cancel</button>
</div>
</form>
<script>
function myfunction() {
