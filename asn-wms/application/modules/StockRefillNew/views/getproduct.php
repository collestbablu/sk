...

    {
	  ...
	  alert("Your broweser doesnot support ajax");
		...
		//document.getElementById("spid").value=tid;
		  ...
		  function abc(pt,pr,sku_no,des2){
				   ...
				   document.getElementById("desc1").value=pt;
				   document.getElementById("desc2").value=des2;
				    document.getElementById("entQty").value=1;
...
onClick="abc(this.value,'<?php echo $arr->productname; ?>^<?php echo $arr->Product_id; ?>','<?php echo $arr->sku_no; ?>','<?php echo $arr->description2; ?>')"
onFocus="abc(this.value,'<?php echo $arr->productname; ?>^<?php echo $arr->Product_id; ?>','<?php echo $arr->sku_no; ?>','<?php echo $arr->description2; ?>')"
