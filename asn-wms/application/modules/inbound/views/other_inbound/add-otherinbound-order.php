...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success btn-sm" href="<?=base_url();?>inbound/otherinbound/manageotherinbound">Manage Inbound</a></li> 
		...
		<ol class="breadcrumb breadcrumb-2"> 
				...
				<li><a href="#">Inbound</a></li> 
				<li class="active"><strong><a href="#">Add Inbound</a></strong></li> 
			</ol>
		<?php }?>
...
<?php if($_GET['id']!=''){ ?>
		<h4 class="panel-title">Update Inbound</h4>
		<?php }elseif($_GET['view']!=''){ ?>
		<h4 class="panel-title">View Inbound</h4>
		<?php }else{ ?> 
		<h4 class="panel-title"><strong>Add Inbound</strong></h4>
		<?php } ?>
...
<div class="col-sm-4">
  <select name="supplier_id" onChange="getOrg(this.value);"  class="form-control ui fluid search dropdown email"  <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?> >
	...
	?>
   <option value="<?=$getBooking->code;?>" <?php if($getBooking->contact_id==$branchFetch->supplier_id){?> selected <?php }?>><?=$getBooking->first_name;?></option>
   <?php }?>
  </select>
...
<th style="display:none;"><input type="number" id="int_tariff" min="1" style="width:70px;"   class="form-control"></th>
...
<td style="width:3%; display:none"> <div align="center"><u>Unit Price</u></div></td>
<td style="width:3%; display:none"> <div align="center"><u>International Tariff No.</u></div></td>
...
<th>&nbsp;</th>
<th><input class="btn btn-primary btn-sm" type="button" value="SAVE"   id="sv1" onClick="fsv(this)" >&nbsp;<a href="<?=base_url();?>inbound/otherinbound/manageotherinbound" class="btn btn-blue btn-sm">Cancel</a></th></th>
</tr>
</tbody>
</table>
</div>
