...
<tr>
<td>Date</td>
<td><?=$obj->explode_date($inviceres->mrn_date);?></td>
</tr>
<tr>

<td>Received AT:  </td>
<td><?=$obj->explode_date($inviceres->date_of_receipt_at_warehose);?></td>
</tr>
<tr>
<td>BOE NO. & DATE:</td>
<td><?=$inviceres->boe_no;?> / <?=$obj->explode_date($inviceres->boe_date);?></td>
</tr>
<tr>
<td>INVOICE NO</td>
<td><?=$inviceres->invoice_no;?> / <?=$obj->explode_date($inviceres->invoice_date);?></td>
</tr>
<tr>
<td>PO NO : </td>
...
{
?>
DEL<?=date('Y')?>00<?=$inviceres->control_no?>
<?php
}
else
{
?>
BLR<?=date('Y')?>00<?=$inviceres->control_no?>
...
<td><?php echo $invoiceFetch->quantity;?></td>
<td><?php echo $invoiceFetch->list_price * $invoiceFetch->quantity;;?></td>
<td><?php echo "0";//$invoiceFetch->quantity - $invoiceFetch->discount;?></td>
<td><?php 
...
<td><?=$listPSum;?></td>
<td>&nbsp;</td>
<td><?php echo $qtySum;//$recdSum;?></td>
<td><?php echo $listPSum;//$netSum;?></td>
<td><?php echo "0";//$difSum;?></td>
<td><?php echo "0";//$diffInv;?></td>
</tr>
<tr>
...
<tr>
<td>Date</td>
<td><?=$obj->explode_date($inviceres->mrn_date);?><?php //$inviceres->date;?></td>
</tr>
<tr>
