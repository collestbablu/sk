...
document.getElementById("grn_no").focus();
}
}



document.getElementById("grn_no").onkeyup = function (e) {
var entr =(e.keyCode);
if(entr==13){
...
document.getElementById("grn_date").onkeyup = function (e) {
var entr =(e.keyCode);
if(document.getElementById("grn_date").value=="" && entr==08){
...
function editselectrow(d,r) 
{
	...
	id=nn;
		...
		var grn_no=document.getElementById("grn_no"+id).value;
...
document.getElementById("grn_no").value=grn_no;
document.getElementById("grn_date").value=grn_date;
...
function deleteselectrow(d,r) //
{
		...
		var order_no=document.getElementById("order_no"+id).value;
	    var i = r.parentNode.parentNode.rowIndex;
	...
	//===================================start 5th cell================================
	    ...
	    cell = row.insertCell(indexcell);
				...
				var grnD = document.createElement("input");
							...
							grnD.value=grn_date;	
							grnD.name ='grn_date[]';
							grnD.id='grn_date'+rid;
							grnD.className="form-control";
							//grnD.readOnly = true;
...
$location='manage_item';
		...
		$hdrQuery=$this->db->query("select *from tbl_stock_in_inv_hdr where stockinhdr='".$_GET['id']."' and inc_id='".$_GET['inc_id']."' ");
		
		
		/*$userQuery = $this -> db
           -> select('*')
		   -> where('stockinhdr',$_GET['id'])
		   -> and_where('stockinhdr',$_GET['view'])
		    -> or_where('stockinhdr',$_GET['view'])
           -> get('tbl_stock_in_inv_hdr');
		   */
		  $branchFetch = $hdrQuery->row();
...
<?php if($_GET['id']!=''){ ?>
		<h4 class="panel-title">Edit Invoice</h4>
		<?php }elseif($_GET['view']!=''){ ?>
		<h4 class="panel-title">Edit Invoice</h4>
		<?php }else{ ?> 
		<h4 class="panel-title"><strong>Edit Invoice</strong></h4>
		<?php } ?>
...
<form class="form-horizontal" onSubmit="return checkKeyPressed(a)" method="post" action="updateMultipleInv" enctype="multipart/form-data">

<input type="hidden" name="id" value="<?=$_GET['id'];?>">
<input type="hidden" name="inc_id" value="<?=$_GET['inc_id'];?>">

<div class="form-group"> 
<label class="col-sm-2 control-label">*Invoice No.:</label> 
<div class="col-sm-4" id="regid"> 
<input type="text" class="form-control" name="inv_no" value="<?=$branchFetch->inv_no;?>">


</div>  
<label class="col-sm-2 control-label">*Order No.:</label> 
<div class="col-sm-4" id="regid"> 
<input type="text" name="order_no" value="<?php echo $branchFetch->order_no; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" required>
</div> 
</div>
...
<div class="col-sm-4" id="regid"> 
<input type="date" class="form-control" name="inv_date" value="<?=$branchFetch->inv_date;?>">
...
<th style="display:none">Domestic Tariff No.</th>
<th>GRN No.</th>
<th>GRN Date</th>
<th>Total</th>
<th>Net Price</th>
...
<th>
<input type="hidden" id="int_tariff">
<input type="number" step="any" name="saleamnt" id="tariff_no" class="form-control"   style="width:90px;"/ ></th>

<th style="display:none1"><input type="number" step="any" name="saleamnt" id="doms_tariff_no" class="form-control"   style="width:110px;"/ ></th>
<th><input type="text" name="saleamnt"  id="grn_no" class="form-control"  style="width:100px;"/ ></th>

<th><input type="date" name="saleamnt"  id="grn_date" class="form-control"  style="width:140px;"/ ></th>
...
<table>
<tr>
<td align="center" style="width: 0.2%;">Sl No.</td>
<td align="center" style="width: 5%;">Product Code</td>
<td align="center" style="width: 8%;">GRN NO.</td>
<td align="center" style="width: 8%;">GRN Date</td>


<td align="center" style="width: 8%;">Description1</td>

<td align="center" style="width: 8%;">Description2</td>
<td align="center" style="width: 3%;">Unit Price</td>
<td align="center" style="width: 2%;">Qty</td>
<td align="center" style="width: 2%;">Qty Rec.</td>
<td align="center" style="width: 2%;">Qty Diff.</td>
<td align="center" style="width: 3%; display:none;">HSN Code</td>
<td align="center" style="width: 3%;">Int.Tariff</td>
<td align="center" style="width: 3%;">HSN Code</td>
<td align="center" style="width: 3%;">Total</td>
<td align="center" style="width: 3%;">Net Price</td>
...
<?php
$z=1;
$query_dtl=$this->db->query("select * from tbl_stock_in_inv_hdr where   inc_id='".$_GET['inc_id']."' and stockinhdr='".$_GET['id']."' or stockinhdr='".$_GET['view']."'  ");
...
<td align="center" style="width: 8%;"><input type="text" name="grn_no[]" id="grn_no<?php echo $z;?>" value="<?php echo $invoiceFetch->grn_no;?>" class="form-control"  style="text-align: center; width: 100%; border:hidden1;"></td>

<td align="center" style="width: 8%;"><input type="date" name="grn_date[]" id="grn_date<?php echo $z;?>" class="form-control" value="<?php echo $invoiceFetch->grn_date;?>"  style="text-align: center; width: 100%; border:hidden1;"></td>
...
<td align="center" style="width: 2%;"><input type="text" name="qty[]" id="qnty<?php echo $z;?>" value="<?php echo $invoiceFetch->quantity;?>"readonly="" style="text-align: center; width: 100%; border: hidden;"></td>


<td align="center" style="width: 2%;"><input type="text" name="discount[]" id="dis<?php echo $z;?>" value="<?php echo $invoiceFetch->discount;?>"readonly="" style="text-align: center; width: 100%; border: hidden;">
</td>

<td align="center" style="width: 2%;"><input type="text" name="disAmount[]" id="disAmount<?php echo $z;?>" value="<?php echo $invoiceFetch->discount_amount;?>"readonly="" style="text-align: center; width: 100%; border: hidden;">
</td>

<td align="center" style="width: 3%;"><input type="text" name="hsn_code[]" id="hsn_code<?php echo $z;?>" value="<?php echo $invoiceFetch->hsn_code;?>"readonly="" style="text-align: center; width: 100%; border: hidden;"></td>
...
$sumT=$sumT+$invoiceFetch->net_price;
...
<tr class="gradeA" style="display:none1;">
<th>Grand Total</th>
<th>&nbsp;</th>
<th>
<input type="number" style="display:none1" readonly="" step="any" id="grand_total" value="<?php echo $sumT; ?>" name="grand_totalsss" placeholder="Placeholder" class="form-control">
<input type="number" style="display:none" readonly="" step="any" id="grand_total" value="<?php echo $branchFetch->grand_total; ?>" name="grand_total" placeholder="Placeholder" class="form-control"></th>
</tr>
...
<?php }?>
<a onClick="popupclose(this.value)" class="btn btn-blue">Cancel</a></th></th>
</tr>
</tbody>
</table>
</div>
