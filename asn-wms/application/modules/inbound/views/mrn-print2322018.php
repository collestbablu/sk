...
<td><?php echo $invoiceFetch1->list_price;?></td>
<td><?=$invoiceFetch1->discount?></td>
<td><?php echo $invoiceFetch1->net_price;?></td>
<td><?php echo $invoiceFetch1->discount_amount;?></td>
<td><?php echo $invoiceFetch1->list_price*$invoiceFetch1->discount_amount;?></td>
</tr>

<?php $qtySum1= $qtySum1+$invoiceFetch1->quantity;
?>
<?php $listPSum=$listPSum+$invoiceFetch1->list_price;?>
<?php $netSum=$netSum+$invoiceFetch1->net_price;?>

<?php $recdSum=$recdSum+$invoiceFetch1->discount;?>
<?php $difSum=$difSum+$invoiceFetch1->discount_amount;?>

<?php $diffInv=$diffInv+$invoiceFetch1->list_price*$invoiceFetch1->discount_amount;?>
