...
<tr>
<td align="center" style="width: 0.2%; background-color:#dddddd;">Sl No..1</td>
<td align="center" style="width: 30%; background-color:#dddddd;">Invoice No..</td>
<td align="center" style="width: 30%; background-color:#dddddd;">Order No..</td>
<td align="center" style="width: 33%!important; background-color:#dddddd;">Invoice Date</td>
<td align="center" style="width: 24%; background-color:#dddddd;">GRN No..</td>
<td align="center" style="width: 24%; background-color:#dddddd;">GRN Date..</td>
<td align="center" style="width: 3%; background-color:#dddddd;">Product Code</td>
<td align="center" style="width: 15%; background-color:#dddddd;">Description1</td>
<td align="center" style="width: 15%; background-color:#dddddd;">Description2</td>
<td align="center" style="width: 8%; background-color:#dddddd;">MRP</td>
<td align="center" style="width: 3%; background-color:#dddddd;">Unit Price</td>
<td align="center" style="width: 3%; background-color:#dddddd;">International Tariff No.</td>
<td align="center" style="width: 3%; background-color:#dddddd;">Qty Invoice</td>
<td align="center" style="width: 3%; background-color:#dddddd; display:none;">Qty Rec.</td>
<td align="center" style="width: 3%; background-color:#dddddd; display:none;">Qty Diff.</td>
<td align="center" style="width: 3%; background-color:#dddddd; display:none;">Total</td>
<td align="center" style="width: 3%; background-color:#dddddd;">Net Price</td>
<!--<td align="center" style="width: 3%;">&nbsp;</td>-->
                ...
                <?php
$z=1;
$query_dtl=$this->db->query("select * from tbl_stock_in_inv_hdr where stockinhdr='".$_GET['id']."' or stockinhdr='".$_GET['view']."' group by stockdtlid");
foreach($query_dtl->result() as $invoiceFetch)
{
...
<tr>
                  ...
                  <td align="center" style="width: 5%;"><input type="text" name="pd[]" id="pd<?php echo $z;?>" value="<?php echo $invoiceFetch->inv_no;?>" readonly="" style="text-align: center; width: 100%; border:hidden;"></td>
                  <td align="center" style="width: 3%;"><input type="text" name="pd[]" id="pd<?php echo $z;?>" value="<?php echo $invoiceFetch->order_no;?>" readonly="" style="text-align: center; width: 100%; border:hidden;"></td>
                  <td align="center" style="width: 3%;"><input type="text" name="pd[]" id="pd<?php echo $z;?>" value="<?php echo $invoiceFetch->inv_date;?>" readonly="" style="text-align: center; width: 100%; border:hidden;"></td>
                  <td align="center" style="width: 3%;"><input type="text" name="pd[]" id="pd<?php echo $z;?>" value="<?php echo $invoiceFetch->grn_no;?>" readonly="" style="text-align: center; width: 100%; border:hidden;"></td>
                  <td align="center" style="width: 3%;"><input type="text" name="pd[]" id="pd<?php echo $z;?>" value="<?php echo $invoiceFetch->grn_date;?>" readonly="" style="text-align: center; width: 100%; border:hidden;"></td>
                  <td align="center" style="width: 3%;"><input type="text" name="pd[]" id="pd<?php echo $z;?>" value="<?php echo $getProductName->sku_no;?>" readonly="" style="text-align: center; width: 100%; border:hidden;"></td>
                  <td align="center" style="width: 8%;"><input type="text" name="pdfsdf[]" id="des1<?php echo $z;?>" value="<?php echo $getProductName->productname;?>" readonly="" style="text-align: center; width: 100%; border:hidden;"></td>
                  <td align="center" style="width: 8%;"><input type="text" name="pdfsd[]" id="des2<?php echo $z;?>" value="<?php echo $getProductName->description2;?>" readonly="" style="text-align: center; width: 100%; border:hidden;"></td>
                  ...
                  <td align="center" style="width: 3%;"><input type="text" name="list_price[]" id="lph<?php echo $z;?>" value="<?php echo $invoiceFetch->list_price;?>" readonly="" style="text-align: center; width: 100%; border: hidden;"></td>
                  <td align="center" style="width: 3%;"><input type="text" name="qty[]" id="qnty<?php echo $z;?>" value="<?php echo $getProductName->tariff;?>"readonly="" style="text-align: center; width: 100%; border: hidden;"></td>
                  ...
                  <td align="center" style="width: 3%;"><input type="text" name="disAmount[]" id="disAmount<?php echo $z;?>" value="<?php echo $invoiceFetch->quantity;?>"readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  ...
                  <td align="center" style="width: 3%; display:none"><input type="text" name="doms_tariff_no[]" id="doms_tariff_no<?php echo $z;?>" value="<?php echo $invoiceFetch->int_tariff;?>"readonly="" style="text-align: center; width: 100%; border: hidden;"></td>
                  <td align="center" style="width: 3%; display:none;"><input type="text" name="tot[]" id="tot<?php echo $z;?>" value="<?php echo $invoiceFetch->total;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  <td align="center" style="width: 3%;"><input type="text" name="nettot[]" id="nettot<?php echo $z;?>" value="<?php echo $invoiceFetch->net_price;?>"readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  <td align="center" style="width: 3%;display:none;"><img src="<?php echo base_url();?>assets/images/delete.png" border="0" name="dlt" id="dlt<?php echo $z;?>" onClick="deleteselectrow(this.id,this);"  readonly style="width: 30%; height: 20%; border: hidden;"><img src="<?php echo base_url();?>assets/images/edit.png" border="0" name="ed" id="ed<?php echo $z;?>" onClick="editselectrow(this.id,this);" style="width: 30%; height: 20%; border: hidden;"></td>
                </tr>
                <?php $row=$z; $z++;  } ?>
              </table>
            </div>
            ...
            <table class="table table-striped table-bordered table-hover" >
              <tbody>
                ...
                <tr class="gradeA">
                  <th> 
                  <th>&nbsp;</th>
                  <th>&nbsp;&nbsp;<a onClick="popupclose(this.value)" class="btn btn-blue btn-sm">Cancel</a></th>
                  </th>
                </tr>
              </tbody>
            </table>
