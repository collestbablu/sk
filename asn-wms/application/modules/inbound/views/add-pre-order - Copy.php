...
<div class="field">
<label class="col-sm-2">*HAWB Booking date:</label> 
<div class="col-sm-4" id="regid"> 
...
<th><input type="number" id="int_tariff" min="1" style="width:70px;"   class="form-control"></th>
...
<th>&nbsp;</th>
<th><input class="btn btn-primary" type="button" value="SAVE"   id="sv1" onClick="fsv(this)" >&nbsp;<a href="<?=base_url();?>inbound/manageInbound" class="btn btn-blue">Cancel</a></th></th>
</tr>
</tbody>
</table>
</div>
