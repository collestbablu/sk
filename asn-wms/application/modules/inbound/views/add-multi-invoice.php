...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success btn-sm" href="<?=base_url();?><?=base_url();?>inbound/manageInbound">Manage Pre Alert</a></li> 
...
<?php if($_GET['id']!=''){ ?>
		<h4 class="panel-title">Add Invoice</h4>
...
$selectQuery=$this->db->query("select *from tbl_stock_in_inv_hdr where stockinhdr='".$_GET['id']."' order by stockdtlid desc limit 0,1");
$getinc=$selectQuery->row();
if($getinc->inc_id=='')
{
$inc='1';	
}
...
<input type="hidden" name="inc_id" value="<?=$inc;?>">
...
<div class="col-sm-4" id="regid"> 
<input type="text" name="grn_no" value="<?php echo $branchFetch->grn_no; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div> 
</div>
...
<div class="col-sm-4" id="regid"> 
<input type="date" class="form-control" name="grn_date" value="<?=$branchFetch->grn_date;?>">
...
<input type="hidden" id="tariff_no" min="1" style="width:110px;"   class="form-control">
<input type="hidden" id="doms_tariff_no" min="1" style="width:110px;"   class="form-control">
<th><input type="number" id="int_tariff" min="1" style="width:110px;"   class="form-control"></th>
...
<th>&nbsp;</th>
<th><input class="btn btn-primary btn-sm" type="button" value="SAVE"   id="sv1" onClick="fsv(this)" >&nbsp;<a onClick="popupclose(this.value)" class="btn btn-blue btn-sm">Cancel</a></th></th>
</tr>
</tbody>
</table>
</div>
