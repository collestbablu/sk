...
<div class="col-sm-4" id="regid"> 
<input type="date" name="eta_date" id="eta_date" min="1" onChange="atafun()" step="any" value="<?php echo $branchFetch->eta_date; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" required>
</div>  
<label class="col-sm-2 control-label">*Order No.:</label> 
<div class="col-sm-4" id="regid"> 
<input type="text" name="order_no" id="order_no" value="<?php echo $branchFetch->order_no; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" required>
</div> 
</div>
<div class="form-group"> 
<div class="field">
...
<div class="col-sm-4" id="regid"> 
  <select name="origin"  class="form-control ui fluid search dropdown email" required <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?> >
	...
	foreach($bookingType->result() as $getBooking){
	?>
   <option value="<?=$getBooking->contact_id;?>" <?php if($getBooking->contact_id==$branchFetch->origin){?> selected <?php }?>><?=$getBooking->first_name;?></option>
   <?php }?>
  </select>
</div> 
</div>
...
<div class="col-sm-4">
<input name="hawb"  type="text" value="<?php echo $branchFetch->hawb; ?>" class="form-control" <?php if($_GET['view']!='') {?> readonly="" <?php }?> required>
...
<div class="col-sm-4" id="regid"> 
 <select name="status"  class="form-control"  <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?> >
    <option value="">----Select ----</option>
    <?php
...
<div class="col-sm-4">
 <input type="date" class="form-control" name="ata_date" id="ata_date"  onChange="atafun()" value="<?=$branchFetch->ata_date;?>">
  </div> 
</div>
<div class="field">
<label class="col-sm-2 control-label">Order Date:</label> 
<div class="col-sm-4" id="regid"> 
  <input type="date" class="form-control" name="order_date" id="order_date" onChange="orderdate()"  value="<?=$branchFetch->order_date;?>">
</div> 
</div>
</div>
...
<div class="col-sm-4" id="regid"> 
 <input name="ge_date"  type="date" value="<?php echo $branchFetch->ge_date; ?>" class="form-control" <?php if($_GET['view']!='') {?> readonly="" <?php }?> >
</div> 
</div>
</div>
<div class="form-group"> 
...
<div class="col-sm-4">
<input name="date_of_receipt_at_warehose" id="date_of_receipt_at_warehose"  type="date" onChange="datefun(this.value)" value="<?php echo $branchFetch->date_of_receipt_at_warehose; ?>" class="form-control" <?php if($_GET['view']!='') {?> readonly="" <?php }?> >
...
<div class="col-sm-4" id="regid"> 
 <input name="international_tat" id="international_tat"  type="text" value="<?php echo $branchFetch->international_tat; ?>" class="form-control" <?php if($_GET['view']!='') {?> readonly="" <?php }?> >
</div> 
</div>
</div>
<div class="form-group"> 
...
<div class="col-sm-4">
<input name="lead_time_from_ata" id="lead_time_from_ata"  type="text" value="<?php echo $branchFetch->lead_time_from_ata; ?>" class="form-control" <?php if($_GET['view']!='') {?> readonly="" <?php }?> >
...
<div class="col-sm-4" id="regid"> 
 <input name="lead_time_from_hawb" id="lead_time_from_hawb"  type="text" value="<?php echo $branchFetch->lead_time_from_hawb; ?>" class="form-control" <?php if($_GET['view']!='') {?> readonly="" <?php }?> >
</div> 
</div>
</div>
...
<div class="col-sm-4" id="regid"> 
 <input name="mrn_date"  type="date" value="<?php echo $branchFetch->mrn_date; ?>" class="form-control" <?php if($_GET['view']!='') {?> readonly="" <?php }?> >
</div> 
</div>
</div>
<div class="form-group"> 
...
<div class="col-sm-4">
<input name="grn_no"  type="text" value="<?php echo $branchFetch->grn_no; ?>" class="form-control" <?php if($_GET['view']!='') {?> readonly="" <?php }?> >
...
<div class="col-sm-4" id="regid"> 
 <input name="grn_date"  type="date" value="<?php echo $branchFetch->grn_date; ?>" class="form-control" <?php if($_GET['view']!='') {?> readonly="" <?php }?> >
</div> 
</div>
</div>
...
<div class="col-sm-4">
<input name="no_of_days"  type="text" value="<?php echo $branchFetch->no_of_days; ?>" class="form-control" <?php if($_GET['view']!='') {?> readonly="" <?php }?> >
...
<th><input type="text" step="any" name="saleamnt" id="hsn_code" class="form-control"  style="width:90px;"/ ></th>
<th><input type="number" step="any" name="saleamnt" id="tariff_no" class="form-control"   style="width:90px;"/ ></th>

<th><input type="number" step="any" name="saleamnt" id="doms_tariff_no" class="form-control"   style="width:90px;"/ ></th>
...
<td style="width:3%;"><div align="center"><u>Dom.Tariff</u></div></td>
