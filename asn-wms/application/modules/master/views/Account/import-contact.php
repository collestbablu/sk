...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success btn-sm" href="<?=base_url();?>master/Item/manage_item">Manage Contact</a></li> 
		...
		<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong><a href="#">Import Contact</a></strong></li> 
			</ol>
		<?php }?>
...
<?php if($_GET['id']!=''){ ?>
		<h4 class="panel-title">Update Contact</h4>
		<?php }elseif($_GET['view']!=''){ ?>
		<h4 class="panel-title">View Contact</h4>
		<?php }else{ ?> 
		<h4 class="panel-title"><strong>Import Contact</strong></h4>
		<?php } ?>
...
<form action="import_contact_insert" method="post" enctype="multipart/form-data">
