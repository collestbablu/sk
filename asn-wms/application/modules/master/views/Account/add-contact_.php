...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success" href="<?=base_url();?>master/Account/manage_contact">Manage Contact</a></li> 
...
<div class="col-sm-4" id="regid"> 
<select name="state_id" class="form-control ui fluid search dropdown email" required>
<option value="">--Select--</option>
<?php
