...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success btn-sm" href="<?=base_url();?>master/ProductCategory/manage_itemctg">Manage Product Category </a></li> 
...
<a href="" onclick="popupclose(this.value)"  title="Cancel" class="btn btn-blue btn-sm"> Cancel</a>
		...
		<input type="submit" class="btn btn-primary btn-sm" value="Save">
       <a href="<?=base_url();?>master/ProductCategory/manage_itemctg" class="btn btn-blue btn-sm">Cancel</a>
