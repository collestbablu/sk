...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success btn-sm" href="<?=base_url();?>master/Item/manage_item">Manage Product</a></li> 
...
<div class="col-sm-4" id="regid"> 
<input type="text" name="pg_group" min="1" step="any" value="<?php echo $branchFetch->pg_group; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div>  
...
<div class="col-sm-4" id="regid"> 
<input type="text" name="family_group" min="1" step="any" value="<?php echo $branchFetch->family_group; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div>  
...
<div class="col-sm-4">
  <select name="inventoy_type"  class="form-control ui fluid search dropdown email"  <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?> >
    <option value="">----Select ----</option>
...
<div class="field">
<label class="col-sm-2 control-label">International Tariff:</label> 
<div class="col-sm-4" id="regid"> 
...
<div class="col-sm-4" id="regid"> 
<input type="text" name="gst_tax" value="<?php echo $branchFetch->gst_tax; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div> 
</div>
...
<div class="col-sm-4" id="regid"> 
<input type="number" name="sales_pack_wt" step="any" value="<?php echo $branchFetch->sales_pack_wt; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div> 
</div>
<div class="form-group"> 
...
<div class="col-sm-4" id="regid"> 
<input type="number" name="carton_weight"  step="any" value="<?php echo $branchFetch->carton_weight; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div>  
<label class="col-sm-2 control-label">Carton Dimensions:</label> 
<div class="col-sm-4" id="regid"> 
<input type="text" name="carton_dimensions"  step="any" value="<?php echo $branchFetch->carton_dimensions; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div>  
</div>
...
<div class="col-sm-4" id="regid"> 
<input type="number" name="master_carton_weight"  step="any" value="<?php echo $branchFetch->master_carton_weight; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div>  
<label class="col-sm-2 control-label">Master Carton Quantity
:</label> 
<div class="col-sm-4" id="regid"> 
<input type="text" name="master_carton_quantity"  step="any" value="<?php echo $branchFetch->master_carton_quantity; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control">
</div>  
</div>
...
<div class="col-sm-4" id="regid"> 
<input type="text" name="master_carton_dimensions"  step="any" value="<?php echo $branchFetch->master_carton_dimensions; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div>  
<label class="col-sm-2 control-label">Crossre Ference:</label> 
<div class="col-sm-4" id="regid"> 
<input type="text" name="crossre_ference"  step="any" value="<?php echo $branchFetch->crossre_ference; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div>  
</div>
<div class="form-group">   
<label class="col-sm-2 control-label">Country Origin:</label> 
<div class="col-sm-4" id="regid"> 
<input type="text" name="country_origin"  step="any" value="<?php echo $branchFetch->country_origin; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div>  
...
<div class="col-sm-4" id="regid"> 
<input type="number" name="inner_master_carton_quantity"  step="any" value="<?php echo $branchFetch->inner_master_carton_quantity; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control">
</div>  
<label class="col-sm-2 control-label">Inner Master Carton W H D:</label> 
<div class="col-sm-4" id="regid"> 
<input type="text" name="inner_master_carton_w_h_d"  step="any" value="<?php echo $branchFetch->inner_master_carton_w_h_d; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div>  
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Minimum Reorder Level:</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" name="min_re_level"  step="any" value="<?php echo $branchFetch->min_re_level;?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div>  
...
<a href="" onClick="popupclose(this.value)"  title="Cancel" class="btn btn-blue btn-sm"> Cancel</a>
		...
		<input type="submit" class="btn btn-primary btn-sm" value="Save">
       <a href="<?=base_url();?>master/Item/manage_item" class="btn btn-blue btn-sm">Cancel</a>
