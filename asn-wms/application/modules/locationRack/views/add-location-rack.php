...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success btn-sm" href="<?=base_url();?>locationRack/manage_location_rack">Manage Location Rack</a></li> 
...
<a href="" onclick="popupclose(this.value)"  title="Cancel" class="btn btn-blue btn-sm"> Cancel</a>
		...
		<input type="submit" class="btn btn-primary btn-sm" value="Save" >
       <a href="<?=base_url();?>locationRack/manage_location_rack" class="btn btn-blue btn-sm">Cancel</a>
